...
module  ALTCLKCTRa_altclkctrl_uhi
	( 
	clkselect,
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //ALTCLKCTRa_altclkctrl_uhi
//VALID FILE
...
module ALTCLKCTRa (
	...
	ALTCLKCTRa_altclkctrl_uhi	ALTCLKCTRa_altclkctrl_uhi_component (
				.clkselect (sub_wire1),
				.ena (sub_wire2),
				.inclk (sub_wire4),
				.outclk (sub_wire0));
